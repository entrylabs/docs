...
후자의 type들은 entry-tool 소스에서는 [constants/index.js](https://github.com/entrylabs/entry-tool/blob/3e6cc0c7c99a158078f6e68a7df6a4451dcf1cdf/src/constants/index.js#L234)에서 확인 가능합니다.

| type         | 단독 기능 여부 | 사용 기능                   | 설명                                                         |
| ------------ | -------------- | --------------------------- | ------------------------------------------------------------ |
| select       | ✔️              | select                      | 카드뷰 형태로 리스트를 출력하고, 사용자가 특정 카드뷰를 선택하는 팝업입니다. |
| upload       | ✔️              | upload                      |                                                              |
| dragUpload   | ✔️              | dragUpload                  |                                                              |
| draw         | ✔️              | draw                        |                                                              |
| write        | ✔️              | write                       |                                                              |
|              |                |                             |                                                              |
...
setData 함수로 sidebar 데이터를 넘겨주는 것으로 좌측 사이드바의 메인 카테고리와 서브 카테고리 지정할 수 있습니다.
