...
```json
{
    ...
    // 오브젝트가 포함한 이미지들 : Array<pictureItem>,
    "pictures": [
        {
            "id": null,
            "name": "점프 엔트리봇_1",
    ...
    // 오브젝트가 포함한 사운드들 : Array<SoundItems>
    "sounds": []
}
```
