...
/example/rl/model.json
/example/rl/weight.json
/lib/ai/[entry-ml 번들링 된 파일들...]
/lib/entry-js/[entryjs의 파일들...]
/index.html
```
<details>
<summary>index.html sample</summary>
...
<html lang="ko">
    <head>
        ...
        <link rel="stylesheet" href="/lib/ai/entry-ml.css" />
        <link rel="stylesheet" href="/css/bb.css" />
        <link href="https://entry-cdn.pstatic.net/lib/entry-tool/dist/entry-tool.css" rel="stylesheet" />
        <link
            href="https://entry-cdn.pstatic.net/lib/entry-lms/dist/assets/app.css"
            rel="stylesheet"
        />
        <style>
            #EntryLearningContainer {
                display: none;
                top: 0;
                bottom: 0;
                left: 0;
        ...
        <script src="https://entry-cdn.pstatic.net/lib/lodash/dist/lodash.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/js/react18/react.production.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/js/react18/react-dom.production.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/PreloadJS/lib/preloadjs-0.6.0.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/EaselJS/lib/easeljs-0.8.0.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/SoundJS/lib/soundjs-0.6.0.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/SoundJS/lib/flashaudioplugin-0.6.0.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/jquery/jquery.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/jquery-ui/ui/minified/jquery-ui.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/velocity/velocity.min.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/lib/codemirror.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/addon/hint/show-hint.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/addon/lint/lint.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/addon/selection/active-line.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/mode/javascript/javascript.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/codemirror/addon/hint/javascript-hint.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/js/ws/jshint.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/fuzzy/lib/fuzzy.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/js/ws/python.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/socket.io-client/socket.io.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/components-webfontloader/webfontloader.js?v=240430-174210"></script>
        <script src="https://entry-cdn.pstatic.net/lib/entry-lms/dist/assets/app.js?v=240430-174210"></script>
      
        <script src="https://entry-cdn.pstatic.net/lib/entry-tool/dist/entry-tool.js"></script>
        <script src="/lib/ai/entry-ml.js" /></script>
        <script src="https://entry-cdn.pstatic.net/lib/entry-paint/dist/static/js/entry-paint.js"></script>

        <script src="https://entry-cdn.pstatic.net/external/sound/sound-editor.js?v=240430-174210"></script>
        ...
        <script src="https://entry-cdn.pstatic.net/module/legacy-video/index.js"></script>
    </head>
    <body>
        ...
        <div id="EntryLearningContainer"></div>
        ...
        <script>
            ...
            const getInstance = async () => {
                ...
                await model.save(`indexeddb://init_test`);
                indexedDbInstance = {
            ...
            const saveWithkeyPath = (store, data) => {
                return new Promise((resolve, reject) => {
                    store.ready().then(() => {
                        ...
                        if (data[objectStore.keyPath]) {
                            ...
                            console.log(`no key ${objectStore.keyPath}`);
                            reject(false);
                        }
                    });
                });
            ...
            const TEMP_MODEL_KEY = 'temp-import-model';
            const importTFModel = async (model, weight, saveUrl) => {
                const store = await getInstance();
                try {
                    if (model) {
                        const weightData = base64ToArrayBuffer(model?.modelArtifacts?.weightData);
                        model.modelArtifacts.weightData = weightData;
                        await saveWithkeyPath(
                            store.tfModel,
                            { ...model, modelPath: TEMP_MODEL_KEY }
                        );
                    }
                    if (weight) {
                        await saveWithkeyPath(
                            store.tfModelInfo,
                            { ...weight, modelPath: TEMP_MODEL_KEY }
                        );
                    }
                    const loadedModel = await tf.loadLayersModel(`indexeddb://${TEMP_MODEL_KEY}`);
                    if (saveUrl) {
                        const savedPath = await loadedModel.save(saveUrl);
                        loadedModel.dispose();
                        tf.disposeVariables();
                        return saveUrl;
                    }
                } catch(e) {
                    console.log('importModel error', e);
                    throw new Error('error');
                } finally {
                    await store.tfModel.removeItem(TEMP_MODEL_KEY);
                    await store.tfModelInfo.removeItem(TEMP_MODEL_KEY);
                }
            }
            ...
            const loadTempModel = async (dataApi) => {
                const info = await loadJSON('/example/rl/info.json');
                const model = await loadJSON('/example/rl/model.json');
                const weight = await loadJSON('/example/rl/weight.json');
                const saveUrl = dataApi.getModelSaveUrl(info.id);
                await dataApi.saveModel(info.id, info);
                await importTFModel(model, weight, saveUrl);
            }
            ...
            function getLearningPopup() {
                if (PopupInstance.learning) {
                    return PopupInstance.learning;
                }
                // 팝업 인스턴스가 없는 경우, 팝업을 띄울 DOM 컨테이너 생성
                const learningContainer = document.getElementById('EntryLearningContainer');

                const dataApi = new Entryml.MlDataApi();
                // 팝업을 초기화하고 생성
                PopupInstance.learning = new Entryml.Popup({
                    container: learningContainer,
                    isShow: false,
                    dataApi,
                    data: {
                        tokenizerPath: '/lib/ai/resources',
                    },
                }).on('submit', (data) => {
                    Entry.dispatchEvent('popupAddBlocks', { category: 'ai_utilize' });
                    const { _id: targetId } = data;
                    Entry.playground.setAiLearningBlock(data);
                })
                .on('remove', () => {
            ...
            function getPredictPopup() {
                if (PopupInstance.predict) {
                    return PopupInstance.predict;
                }
                const learningPredictContainer = document.getElementById('EntryLearningPredictContainer');
                PopupInstance.predict = new Entryml.Predict({
                    container: learningPredictContainer,
                    isShow: false,
                })
                .on('show', () => {
            ...
            function showMLInputPopup(args) {
                const learningPredict = getPredictPopup();
                if (Entry.engine.state == 'run') {
                    Entry.engine.togglePause({ visible: false });
                }
                console.log(args);
            ...
            function openAIUtilizeTrainManager() {
                const learningPopup = getLearningPopup();
                learningPopup.show()
            }
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                Entry.addEventListener('openMLInputPopup', (args) => {
                    showMLInputPopup(args);
                });
                loadTempModel(dataApi).then(() => {
                    Entry.loadProject({
                        "objects": [
                            {
                                "id": "7y0y",
                                "name": "엔트리봇",
                                "script": "[[{\"id\":\"wvn1\",\"x\":28.5,\"y\":30,\"type\":\"when_run_button_click\",\"params\":[null],\"statements\":[],\"movable\":null,\"deletable\":1,\"emphasized\":false,\"readOnly\":null,\"copyable\":true,\"assemble\":true,\"extensions\":[]},{\"id\":\"rbw7\",\"x\":0,\"y\":0,\"type\":\"insert_data_for_test\",\"params\":[null],\"statements\":[],\"movable\":null,\"deletable\":1,\"emphasized\":false,\"readOnly\":null,\"copyable\":true,\"assemble\":true,\"extensions\":[]},{\"id\":\"k1xv\",\"x\":0,\"y\":0,\"type\":\"dialog\",\"params\":[{\"id\":\"dr8v\",\"x\":0,\"y\":0,\"type\":\"test_result\",\"params\":[null],\"statements\":[],\"movable\":null,\"deletable\":1,\"emphasized\":false,\"readOnly\":null,\"copyable\":true,\"assemble\":true,\"extensions\":[]},\"speak\",null],\"statements\":[],\"movable\":null,\"deletable\":1,\"emphasized\":false,\"readOnly\":null,\"copyable\":true,\"assemble\":true,\"extensions\":[]}]]",
                                "objectType": "sprite",
                                "rotateMethod": "free",
                                "scene": "7dwq",
                                "sprite": {
                        ...
                        "learning": {
                            ...
                            "url": "indexeddb://66a87e64e1dd981d13df2e48",
                            "type": "image",
                            "id": "66a87e64e1dd981d13df2e48",
                            "_id": "66a87e64e1dd981d13df2e48",
                            "recordTime": 3000,
                            "tableData": null
                        },
                        "externalModules": [],
...
<details>
<summary>indexedDB 클래스 예시</summary>
...
![ml_popup_deleteModel1](/images/entry-ml/ml_popup_deleteModel1.png)

![ml_popup_deleteModel2](/images/entry-ml/ml_popup_deleteModel2.png)
...
![ml_popup_copyModel1](/images/entry-ml/ml_popup_copyModel1.png)
...
![ml_popup_downloadModel1](/images/entry-ml/ml_popup_downloadModel1.png)
...
![ml_popup_saveData1](/images/entry-ml/ml_popup_saveData1.png)
