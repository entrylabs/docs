...
가로축과 계열에 해당하는 속성을 선택하면 막대 차트를 그려요. 
...
- **원 차트**
  ...
  전체 중에서 어떤 데이터가 차지하는 정도를 분석할 때 좋은 차트예요. 
  계열, 값의 속성을 선택하면 원 차트를 그려요.
...
- **히스토그램 차트**
  ...
  ![tab_chart-scatter](images/window/table2/tab_chart-histogram.gif)
  연속형 데이터의 계급별 비교를 할 때 좋은 차트에요. 그래프의 계열, 계급 수, 그리고 계급 경계를 선택하면 히스토그램 차트를 그려요.
  각 계급(막대)에 마우스를 올리면 해당 막대의 데이터 정보를 보여주는 상자가 나타납니다.
