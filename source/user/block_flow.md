...
이 블록 다음에 조립되어 있는 블록부터 동작하지 않고, 반복도 멈추게 됩니다.
...
이 블록을 감싼 가장 가까운 반복 블록의 이번 반복을 건너뛰고, 다음 반복의 처음부터 실행합니다.

'반복 중단하기'와 달리 반복 중의 이번 시행만 건너뛰어요.
...
![block-flow](images/block-flow-15.png)
